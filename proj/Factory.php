...
<body> 
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="disp_factory.php">DISPLAY</a>
...
<h2 style="color:white">Factory's Form</h2>

<div >
  <form width="30%"  method="post" action="factory_script.php" >
    
    <input type="text" id="id" name="id" placeholder="factory id..">
    <br/>
     <input type="text" id="location" name="location" placeholder="location..">
    <br/>
    <input type="text" id="name" name="name" placeholder="factory name..">
    <br/>
    <input type="text" id="mgrssn" name="mgrssn" placeholder=" manager ssn..">
    <br/>
    <input type="text" id="fbid" name="fbid" placeholder=" bulb id..">
    <br/>
