...
<body> 
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="disp_bulb.php">DISPLAY</a>
...
<br/>
<br/>
<h1 style="color: #fff">Bulb's Form</h1>
<div >
  <form width="30%"  method="post" action="bulb_script.php" >
    
    <input type="text" id="bid" name="bid" placeholder="bulb id..">
    <br/>
    <input type="text" id="bname" name="bname" placeholder="bulb name..">
    <br/>
    <input type="text" id="quantity" name="quantity" placeholder=" bulb quantity..">
    <br/>
    <input type="text" id="price" name="price" placeholder=" bulb price..">
    <br/>
