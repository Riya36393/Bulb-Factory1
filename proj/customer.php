...
<body> 
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="customer1_profile.php">DISPLAY</a>
...
<center>
<div >
  <form width="30%"  method="post" action="customer_script.php" >
    
    <input type="text" id="cid" name="cid" placeholder="customer id..">
    <br/>
    <input type="text" id="name" name="cname" placeholder="customer name..">
    <br/>
    <input type="text" id="address" name="caddress" placeholder=" customer address..">
    <br/>
    <input type="text" id="uname" name="cuname" placeholder=" customer uname..">
    <br/>
