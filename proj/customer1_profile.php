...
if(!$conn ) {
   ...
   $sql = "SELECT * FROM customer where cuname='$cuname'";
...
<h1 style="color: #fff" > Customer's profile</h1>
...
<div style="color: #fff">cid: <?php echo $row['cid']; ?></div><br>
<div style="color: #fff">name: <?php echo $row['cname']; ?></div><br>
<div style="color: #fff">address: <?php echo $row['caddress']; ?></div><br>
<div style="color: #fff">uname: <?php echo $row['cuname']; ?></div><br>
<div style="color: #fff"><?php echo " <a href='delete1_customer.php?cid=".$row['cid']."'>delete</a><br>"; ?></div><br>
<br><br>
