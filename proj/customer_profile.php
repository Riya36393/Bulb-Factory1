...
<center>
<div style="color: #fff">cid: <?php echo $cid; ?></div><br>
<div style="color: #fff">name: <?php echo $cname; ?></div><br>
<div style="color: #fff">address: <?php echo $caddress; ?></div><br>
<div style="color: #fff">uname: <?php echo $cuname; ?></div><br>
