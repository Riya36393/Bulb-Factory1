...
<h2 style="color: #fff">REGISTERATION FORM</h2>
<div>
<form method="post" action="register_script.php">
   ...
   <input type="password" id="password" name="password" placeholder=" password..">
    ...
    <br/>
    <input type="radio" name="as" value="worker">worker <input type="radio" name="as" value="customer">customer <input type="radio" name="as" value="manager">manager
...
<style="text-align:center" colspan="2"><h4 style="color: #fff">Have an account?<a href="Login.php">Login</a></h4> 
