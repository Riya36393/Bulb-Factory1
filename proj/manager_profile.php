...
<h1 style="color: #fff" > Manager's profile</h1>
...
<center>
<div style="color: #fff">ssn: <?php echo $mssn; ?></div><br>
<div style="color: #fff">name: <?php echo $mname; ?></div><br>
<div style="color: #fff">address: <?php echo $maddress; ?></div><br>
<div style="color: #fff">uname: <?php echo $muname; ?></div><br>
