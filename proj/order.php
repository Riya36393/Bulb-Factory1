...
<h1 style="color: #fff">Order's Form</h1>




<div >
  <form width="30%"  method="post" action="order_script.php" >
    
    <input type="text" id="obid" name="obid" placeholder="bulb id..">
    <br/>
     <input type="text" id="ocid" name="ocid" placeholder="customer id..">
     <br/>
     <input type="text" id="oquantity" name="oquantity" placeholder="quantity..">
     <br/>
    <input type="text" id="no_of_stars" name="no_of_stars" placeholder="no_of_stars..">
    <br/>
